package com.start.tools.domain.export-app.tools.domain.export;
...
import com.start-app.common.jdbc.CustomNamingStrategy;
...
public class SchemaGenerator {
	...
	public static void main(String[] args) throws Exception {
		SchemaGenerator gen = new SchemaGenerator(
		        "com.start-app.api.domain", "com.start-app.api.domain.sys");
